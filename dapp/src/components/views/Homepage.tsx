...
import { BEARISH, BULLISH, COLLECTION, CURSED_FUND_ADDRESS, CURSED_FUND_ARBISCAN, DBL_MINIMUM } from "constants/index";
...
const HomePage = () => {
  ...
  const fundUsdcBalance = useTokenBalance(USDC.arbitrumAddress, CURSED_FUND_ADDRESS, { chainId: ARBITRUM.chainId });
  const fundWethBalance = useTokenBalance(WETH.arbitrumAddress, CURSED_FUND_ADDRESS, { chainId: ARBITRUM.chainId });
            ...
            <div className="w-full items-center justify-between p-6 border-none space-x-6">
              ...
              {chainId && chainId === ARBITRUM.chainId ? (
                ...
                <div className="text-theme-pan-navy">
                  ...
                  <span className={parseFloat(dblBalance) < DBL_MINIMUM ? 'opacity-50' : ''}>
                    ...
                    <p className="pb-1">
                      <span className="font-bold">Every week</span> the sentiment of our crew is automatically weighted to rebalance a <a href={CURSED_FUND_ARBISCAN} target="_blank" className="text-theme-pan-sky hover:opacity-80">wallet</a> between a 0-100% allocation to $ETH.
                    </p>
                    <p>
                      <span className="font-bold">Every month</span> 0.5% of the fund is withdrawn and distributed 20:80 between development & the DBL/WETH pool.
                    </p>
                  </span>
                  {parseFloat(dblBalance) < DBL_MINIMUM ?
                    <></>
                    : <><span className=" font-bold inline-flex items-center rounded-full py-0.5 text-md text-theme-pan-navy">
                      ...
                      <span className="text-theme-sky pl-2">
                        {parseFloat(dblBalance).toFixed(2)}</span>
                    </span> <div className="inline-flex pl-1 translate-y-1.5 justify-start">
                        <Box
            ...
            <div className="w-full items-center justify-between p-6 space-x-6">
              ...
              <div>
                ...
                {account ? <div className="  ">
                  ...
                  <dl className="mt-5 mb-5 grid grid-cols-1 gap-5 sm:grid-cols-2 justify-center">
                    ...
                    <div className="overflow-hidden rounded-lg bg-theme-white px-4 py-5 border border-theme-pan-navy sm:p-6">
                      <dt className="truncate text-sm font-bold text-theme-pan-navy">WETH</dt>
                      <dd className="mt-1 text-3xl font-semibold tracking-tight text-theme-pan-sky">  <span className=" ">
                    ...
                    <div className="overflow-hidden rounded-lg bg-white px-4 py-5 border border-theme-pan-navy sm:p-6">
                      <dt className="truncate text-sm font-bold text-theme-pan-navy">USDC</dt>
                      <dd className="mt-1 text-3xl font-semibold tracking-tight text-theme-pan-sky">  <span className=" ">
                ...
                <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                  ...
                  <div className="overflow-hidden rounded-lg bg-theme-white  px-4 py-5 border border-theme-pan-navy sm:p-6">
                    <dt className="truncate text-md font-medium text-theme-pan-navy">Total Voters</dt>
